...
def send_email_for_email_verification(*,receiver_email: str, token: str):
    ...
    email_verification_template_path = Path(r"D:\Projects\Fickel\Monolithic\backend\app\template\emailverification_template.html")
    msg = MIMEMultipart()
    ...
    ("HELLO")
    send_mail(sender_email=sender_email, receiver_email=receiver_email, msg=msg.as_string())
